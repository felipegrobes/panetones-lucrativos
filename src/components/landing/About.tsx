    ...
    <section id="about" className="py-16 sm:py-24">
      <div className="container text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-lg text-foreground/80 text-balance">
          Somos una empresa en constante crecimiento. Nuestro objetivo es ayudarte con nuestras recetas y ofrecerte el soporte necesario para que alcances tus resultados. No estás solo(a), puedes contar con nosotros siempre que lo necesites. 😉
        </p>
